...
const VPS_HOST = 'brad.afrihall.com';                // Nouveau domaine du VPS
const VPS_PORT = 80;                                    // Port du VPS
const UUID = 'ee054fe1-9e46-4ef0-8e13-f08f031f7c20';    // Nouvel UUID
const VPS_IP = '134.122.52.175';                        // Nouvelle IP
...
const HOST_HEADER = 'main-bvxea6i-h55ymxudy6frs.fr-3.platformsh.site/';  // Nouveau domaine Upsun
const SNI = 'main-bvxea6i-h55ymxudy6frs.fr-3.platformsh.site/';
const ALPN = ['h2', 'http/1.1', 'h3'];
const FP = 'chrome';

// Domaine Upsun
const DOMAIN = process.env.DOMAIN || 'main-bvxea6i-h55ymxudy6frs.fr-3.platformsh.site/';
